GRANT ALL PRIVILEGES ON bulwark_postfix .* TO 'postfix'@'localhost';
GRANT ALL PRIVILEGES ON bulwark_proftpd .* TO 'proftpd'@'localhost';
...
CREATE DATABASE bulwark_postfix;
CREATE DATABASE bulwark_proftpd;
CREATE DATABASE bulwark_roundcube;