-- Sentora Core schema dump 2026-06-30
-- FreeBSD + MariaDB
...
INSERT INTO `x_modules` (`mo_id_pk`, `mo_category_fk`, `mo_name_vc`, `mo_version_in`, `mo_folder_vc`, `mo_type_en`, `mo_desc_tx`, `mo_installed_ts`, `mo_enabled_en`, `mo_updatever_vc`, `mo_updateurl_tx`) VALUES ('4', '2', 'Sentora Config', '200', 'sentoraconfig', 'user', 'Changes made here affect the entire Sentora configuration, please double check everything before saving changes.', NULL, 'true', NULL, '');
INSERT INTO `x_modules` (`mo_id_pk`, `mo_category_fk`, `mo_name_vc`, `mo_version_in`, `mo_folder_vc`, `mo_type_en`, `mo_desc_tx`, `mo_installed_ts`, `mo_enabled_en`, `mo_updatever_vc`, `mo_updateurl_tx`) VALUES ('6', '2', 'Updates', '200', 'updates', 'user', 'Check to see if there are any available updates to your version of the Sentora software.', NULL, 'true', NULL, '');
INSERT INTO `x_modules` (`mo_id_pk`, `mo_category_fk`, `mo_name_vc`, `mo_version_in`, `mo_folder_vc`, `mo_type_en`, `mo_desc_tx`, `mo_installed_ts`, `mo_enabled_en`, `mo_updatever_vc`, `mo_updateurl_tx`) VALUES ('8', '4', 'phpMyAdmin', '200', 'phpmyadmin', 'user', 'phpMyAdmin is a web based tool that enables you to manage your Sentora MySQL databases via. the web.', NULL, 'true', NULL, '');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('7', 'sentora_root', 'Sentora root path', '/usr/local/sentora/', NULL, 'Sentora Web Root', 'Sentora Config', 'false');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('8', 'module_icons_pr', 'Icons per Row', '10', NULL, 'Set the number of icons to display before beginning a new line.', 'Sentora Config', 'false');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('10', 'Sentora_df', 'Date Format', 'H:i jS M Y T', NULL, 'Set the date format used by modules.', 'Sentora Config', 'true');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('13', 'servicechk_to', 'Service Check Timeout', '10', NULL, 'Service Check Timeout', 'Sentora Config', 'true');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('14', 'root_drive', 'Root Drive', '/', NULL, 'The root drive where Sentora is installed.', 'Sentora Config', 'true');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('16', 'php_exer', 'PHP executable', 'php', NULL, 'PHP Executable', 'Sentora Config', 'false');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('17', 'temp_dir', 'Temp Directory', '/var/sentora/temp/', NULL, 'Global temp directory.', 'Sentora Config', 'false');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('21', 'server_ip', 'Server IP Address', '192.168.1.109', NULL, 'If set this will use this manually entered server IP address which is the prefered method for use behind a firewall.', 'Sentora Config', 'false');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('148', 'server_ip6', 'Server IPv6 Address', '', NULL, 'IPv6 primaria del servidor (doble pila). Si se define, el panel escucha tambien en [IPv6]:puerto. Vacio = panel solo por IPv4.', 'Sentora Config', 'false');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('22', 'zip_exe', 'ZIP Exe', 'zip', NULL, 'Path to the ZIP Executable', 'Sentora Config', 'false');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('24', 'disable_hostsen', 'Disable auto HOSTS file entry', 'false', 'true|false', 'Disable Host Entries', 'Sentora Config', 'false');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('25', 'latestzpversion', 'Cached version of latest sentora version', '2.0.0', NULL, 'This is used for caching the latest version of Sentora.', 'Sentora Config', 'false');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('26', 'logmode', 'Debug logging mode', 'db', 'db|file|email', 'The default mode to log all errors in.', 'Sentora Config', 'true');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('27', 'logfile', 'Sentora Log file', '/var/sentora/logs/sentora.log', NULL, 'If logging is set to \'file\' mode this is the path to the log file that is to be used by Sentora.', 'Sentora Config', 'false');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('28', 'apikey', 'XMWS API Key', '82d19584899d47b68a5e0835592c7dfe', NULL, 'The secret API key for the server.', 'Sentora Config', 'false');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('29', 'email_from_address', 'From Address', 'sentora@localhost', NULL, 'The email address to appear in the From field of emails sent by Sentora.', 'Sentora Config', 'true');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('30', 'email_from_name', 'From Name', 'Sentora Server', NULL, 'The name to appear in the From field of emails sent by Sentora.', 'Sentora Config', 'true');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('31', 'email_smtp', 'Use SMTP', 'false', 'true|false', 'Use SMTP server to send emails from. (true/false)', 'Sentora Config', 'true');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('32', 'smtp_auth', 'Use AUTH', 'false', 'true|false', 'SMTP requires authentication. (true/false)', 'Sentora Config', 'true');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('33', 'smtp_server', 'SMTP Server', '', NULL, 'The address of the SMTP server.', 'Sentora Config', 'true');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('34', 'smtp_port', 'SMTP Port', '465', NULL, 'The port address of the SMTP server (usually 25)', 'Sentora Config', 'true');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('35', 'smtp_username', 'SMTP User', '', NULL, 'Username for authentication on the SMTP server.', 'Sentora Config', 'true');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('36', 'smtp_password', 'SMTP Pass', '', NULL, 'Password for authentication on the SMTP server.', 'Sentora Config', 'true');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('37', 'smtp_secure', 'SMTP Auth method', 'false', 'false|ssl|tls', 'If specified will attempt to use encryption to connect to the server, if \'false\' this is disabled. Available options: false, ssl, tls', 'Sentora Config', 'true');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('51', 'mailserver_db', 'Mailserver Database', 'sentora_postfix', NULL, 'The name of the mail server database', 'Mail Config', 'false');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('56', 'named_dir', 'Named Directory', '/usr/local/etc/sentora/bind/etc/', NULL, 'Path to the directory where named.conf is stored', 'DNS Config', 'false');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('58', 'zone_dir', 'Zone Directory', '/usr/local/etc/sentora/bind/zones/', NULL, 'Path to where DNS zone files are stored', 'DNS Config', 'false');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('68', 'bind_log', 'Bind Log', '/var/sentora/logs/bind/bind.log', NULL, 'Path and name of the Bind Log', 'DNS Config', 'false');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('69', 'hosted_dir', 'Vhosts Directory', '/var/sentora/hostdata/', NULL, 'Virtual host directory', 'Apache Config', 'false');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('71', 'apache_vhost', 'Apache VHOST Conf', '/usr/local/etc/sentora/apache/httpd-vhosts.conf', NULL, 'The full system path and filename of the Apache VHOST configuration name.', 'Apache Config', 'false');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('75', 'static_dir', 'Static Pages Directory', '/usr/local/sentora/etc/static/', NULL, 'The Sentora static directory, used for storing welcome pages etc. etc.', 'Apache Config', 'false');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('76', 'parking_path', 'Vhost Parking Path', '/usr/local/sentora/etc/static/parking/', NULL, 'The path to the parking website, this will be used by all clients.', 'Apache Config', 'false');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('79', 'upload_temp_dir', 'Upload Temp Directory', '/var/sentora/temp/', NULL, 'The path to the Apache Upload directory (with trailing slash)', 'Apache Config', 'false');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('84', 'openbase_temp', 'Open Base Temp Directory', '/var/sentora/temp/', NULL, 'Temp directory used in open_base_directory setting', 'Apache Config', 'false');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('87', 'global_zpcustom', 'Global Sentora Entry', NULL, NULL, 'Extra directives for Sentora default vhost.', 'Apache Config', 'true');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('90', 'sentora_domain', 'Sentora Domain', 'panel.pulpo.com', NULL, 'Domain that the control panel is installed under.', 'Sentora Config', 'false');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('91', 'log_dir', 'Log Directory', '/var/sentora/logs/', NULL, 'Root path to directory log folders', 'Sentora Config', 'false');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('95', 'apache_budir', 'VHost Backup Dir', '/var/sentora/backups/', NULL, 'Directory that vhost.conf backups are stored.', 'Apache Config', 'true');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('103', 'daemon_exer', NULL, '/usr/local/sentora/bin/daemon.php', NULL, 'Path to the Sentora daemon', 'Sentora Config', 'false');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('104', 'daemon_timing', NULL, '0 * * * *', NULL, 'Cron time for when to run the Sentora daemon', 'Sentora Config', 'false');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('105', 'cron_file', 'Cron File', '/var/sentora/cron/www.cron', NULL, 'Fichero crontab generado por el panel (staging www-writable, instalado en cron via doas)', 'Cron Config', 'false');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('107', 'mysqldump_exe', 'MySQL Dump', 'mysqldump', NULL, 'Path to MySQL dump', 'Sentora Config', 'false');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('112', 'mailer_type', 'Mail method', 'mail', 'mail|smtp', 'Method to use when sending emails out. (mail = PHP Mail())', 'Sentora Config', 'true');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('113', 'daemon_run_interval', 'Number of seconds between each daemon execution', '300', NULL, 'The total number of seconds between each daemon run (default 300 = 5 mins)', 'Sentora Config', 'false');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('114', 'debug_mode', 'Sentora Debug Mode', 'prod', 'dev|prod', 'Whether or not to show PHP debug errors,warnings and notices', 'Sentora Config', 'true');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('115', 'password_minlength', 'Min Password Length', '10', NULL, 'Minimum length required for new passwords', 'Sentora Config', 'true');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('120', 'login_csfr', 'Remote Login Forms', 'false', 'false|true', 'Disables CSFR protection on the login form to enable remote login forms.', 'Sentora Config', 'false');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('121', 'sentora_port', 'Sentora Apache Port', '443', NULL, 'Sentora Apache panel port (change will be pending until next daemon run)', 'Sentora Config', 'true');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('123', 'panel_ssl_tx', 'Sentora Panel SSL Config', 'SSLEngine On\nSSLProtocol all -SSLv3 -TLSv1 -TLSv1.1\nSSLCipherSuite ECDHE-RSA-AES128-GCM-SHA256:ECDHE-RSA-AES256-GCM-SHA384\nSSLCertificateFile /usr/local/etc/sentora/panel/recovery/selfsigned.crt\nSSLCertificateKeyFile /usr/local/etc/sentora/panel/recovery/selfsigned.key', NULL, 'Sentora SSL settings and certs', 'Sentora Config', 'false');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('147', 'dns_cluster_token', 'Token del cluster DNS', '', NULL, 'Secreto compartido que autentica las llamadas entre nodos del cluster. No compartir fuera del cluster.', 'Sentora Config', 'true');
...
INSERT INTO `x_translations` (`tr_id_pk`, `tr_en_tx`, `tr_de_tx`) VALUES ('71', 'Sentora Config', 'Config Sentora');
INSERT INTO `x_translations` (`tr_id_pk`, `tr_en_tx`, `tr_de_tx`) VALUES ('72', 'Sentora News', 'Sentora Aktuelles');
...
INSERT INTO `x_translations` (`tr_id_pk`, `tr_en_tx`, `tr_de_tx`) VALUES ('97', 'Check to see if there are any available updates to your version of the Sentora software.', 'Prüfen Sie, ob es irgendwelche verfügbaren Aktualisierungen für Ihre Version des Sentora Software.');
INSERT INTO `x_translations` (`tr_id_pk`, `tr_en_tx`, `tr_de_tx`) VALUES ('98', 'If you have found a bug with Sentora you can report it here.', 'Did you mean: If you have found a bug with CPanel you can report it here.\r\nWenn Sie einen Fehler mit Sentora gefunden haben, können Sie ihn hier melden.');
INSERT INTO `x_translations` (`tr_id_pk`, `tr_en_tx`, `tr_de_tx`) VALUES ('99', 'phpMyAdmin is a web based tool that enables you to manage your Sentora MySQL databases via. the web.', 'phpMyAdmin ist ein webbasiertes Tool, das Sie zu Ihrem Sentora MySQL-Datenbanken via verwalten können. im Internet.');
...
INSERT INTO `x_translations` (`tr_id_pk`, `tr_en_tx`, `tr_de_tx`) VALUES ('111', 'Welcome to the Package Manager, using this module enables you to create and manage existing reseller packages on your Sentora hosting account.', 'Willkommen auf der Paket-Manager, mit diesem Modul ermöglicht Ihnen die Erstellung und Verwaltung von bestehenden Reseller-Pakete auf Ihrem Sentora Hosting-Account.');
...
INSERT INTO `x_translations` (`tr_id_pk`, `tr_en_tx`, `tr_de_tx`) VALUES ('174', 'Sentora Version', NULL);
