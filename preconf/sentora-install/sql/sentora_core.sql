...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('7', 'sentora_root', 'Sentora root path', '/usr/local/bulwark/', NULL, 'Sentora Web Root', 'Sentora Config', 'false');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('17', 'temp_dir', 'Temp Directory', '/var/bulwark/temp/', NULL, 'Global temp directory.', 'Sentora Config', 'false');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('75', 'static_dir', 'Static Pages Directory', '/usr/local/bulwark/etc/static/', NULL, 'The Sentora static directory, used for storing welcome pages etc. etc.', 'Apache Config', 'false');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('91', 'log_dir', 'Log Directory', '/var/bulwark/logs/', NULL, 'Root path to directory log folders', 'Sentora Config', 'false');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('103', 'daemon_exer', NULL, '/usr/local/bulwark/bin/daemon.php', NULL, 'Path to the Sentora daemon', 'Sentora Config', 'false');
