...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('105', 'cron_file', 'Cron File', '/var/cron/tabs/www', NULL, 'Path to the user cron file', 'Cron Config', 'false');
