...
(7,'sentora_root','Sentora root path','/usr/local/sentora/',NULL,'Sentora Web Root','Sentora Config','true'),
...
(56,'named_dir','Named Directory','/usr/local/etc/sentora/bind/etc/',NULL,'Path to the directory where named.conf is stored','DNS Config','true'),
(57,'named_conf','Named Config','named.conf',NULL,'Named configuration file','DNS Config','true'),
(58,'zone_dir','Zone Directory','/usr/local/etc/sentora/bind/zones/',NULL,'Path to where DNS zone files are stored','DNS Config','true'),
...
(71,'apache_vhost','Apache VHOST Conf','/usr/local/etc/sentora/apache/httpd-vhosts.conf',NULL,'The full system path and filename of the Apache VHOST configuration name.','Apache Config','true'),
...
(75,'static_dir','Static Pages Directory','/usr/local/sentora/etc/static/',NULL,'The Sentora static directory, used for storing welcome pages etc. etc.','Apache Config','true'),
(76,'parking_path','Vhost Parking Path','/usr/local/sentora/etc/static/parking/',NULL,'The path to the parking website, this will be used by all clients.','Apache Config','true'),
...
(99,'zsudo','zsudo path','/usr/local/sentora/bin/zsudo',NULL,'Path to the zsudo binary used by Apache to run system commands.','Sentora Config','true');
insert  into `x_settings`(`so_id_pk`,`so_name_vc`,`so_cleanname_vc`,`so_value_tx`,`so_defvalues_tx`,`so_desc_tx`,`so_module_vc`,`so_usereditable_en`) values 
...
(103,'daemon_exer',NULL,'/usr/local/sentora/bin/daemon.php',NULL,'Path to the Sentora daemon','Sentora Config','false'),
