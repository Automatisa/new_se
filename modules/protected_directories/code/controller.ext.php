...
class module_controller extends ctrl_module
{
    ...
    static function writeHtaccessLink($realPath, $message, $append=false)
    {
    ...
    static function doCreateProtection()
    {
        ...
        if(!self::hasFlashErrors()) { self::writeHtaccessLink($fileTarget, $message, $append); }
    ...
    static function doEditProtection()
    {
        ...
        // Write htaccess configs to link to passwd file
        $append = !$exists ? false : true;
        if(!self::hasFlashErrors()) { self::writeHtaccessLink($file['x_htpasswd_file_target'], $message, $append); }
