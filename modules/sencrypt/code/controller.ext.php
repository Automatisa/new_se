...
# Module & Dispaly stuff - START
	...
	// ===== Vista de administración de Let's Encrypt (solo admin, grupo 1) =========================
	// Estado global + tabla de todos los certificados (x_le_status, cacheada por el daemon) +
	// pendientes/cola + últimos mensajes del log. Solo lectura.
	static function getLeAdminHTML() {
		global $zdbh;
		$user = ctrl_users::GetUserDetail();
		if ((int)($user['usergroupid'] ?? 3) !== (int)ctrl_groups::GROUP_ADMIN) return '';
